...
function preload(){
  ...
  estradaImage = loadImage('imagens/Ambiente/Pista2.png');
  fundoImagem = loadImage ('imagens/Ambiente/Fundo.png');
  fundofase2 = loadImage ('imagens/Ambiente/fundo 2.png');
  heroiImage = loadImage('imagens/skate/movendo/1a.png');
  obstImage = loadImage('imagens/obst/hidr2.png');
  vida1 = loadImage('imagens/vida/vida.png');
  vida2 = loadImage('imagens/vida/vida2.png');
  img_over = loadImage('imagens/skate/gameover.jpg');
  luvas = loadImage('imagens/obst/Luvas.png');
  juelheira = loadImage('imagens/obst/Juelheira.png');
  cotoveleira = loadImage('imagens/obst/Cotoveleira.png');
  pare = loadImage('imagens/obst/Pare.png');
  cones = loadImage('imagens/obst/Cone.png');
  myFont = loadFont('BerthaMelanie.ttf');
